...
{% grouppicture 2-2 %}
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/01-12-2025-U8-Test-1-Molly.jpeg)
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/01-12-2025-U8-Test-2-Molly.jpeg)
{% endgrouppicture %}

阅读有两道判断粗心，其它部分都掌握得不错，完成得很认真。
...
子墨对于故事要素有一定的了解，能够很快地找到故事的 characters, settings, plot 则需要用自己的语言来总结，子墨经过思考之后也能很快对之前学习的故事总结出起因和结果，经过则需要用更精简的句子提炼。P97 关于BME的排序也有一定难度，子墨开始也粗心选错了，需要仔细阅读，了解大意才行。因为在学校正好学习了不同版本的*Stone Soup*, 所以本课的词汇和故事情节子墨都很熟悉。
...
<mark>Molly 对数字反应很快，能够快速准确地用不同方式（正序、倒序、双数）来数数 1–20 最后挑战速度比老师都还快。能用不同的符号来表达数学等式，同时创编自己的应用题。课文可以基本听一次后跟读，但有些长句子和新的表达还是有一定难度，可以多多跟读挑战一下。</mark>
...
- Magic *e* + long *i*
	...
	- [*ike*](https://elt.oup.com/elt/students/oxfordphonicsworld/video/opw_sb3_u02_ike.mp4?cc=cn&selLanguage=zh)
- 复习同样发 long *i* 的两个字母组合
...
{% grouppicture 2-2 %}
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/Molly-U6-test-1.jpeg)
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/Molly-U6-test-2.jpeg)
{% endgrouppicture %}

- Unit 6 第六单元小测试
	- <mark>词汇和语法部分掌握得很好，阅读理解有个小问题，没有把 <em>put out food</em> 和 <em>take care of</em>联系在一起。</mark>
- 学习自然拼读 Magic *e* + long *i*
- 复习天气词汇，回顾每个季节天气的不同
- 讨论每个季节你都会做什么特别的活动
	- <mark>Molly 提到了很多活动，比如 jumping in the rain, go swimming, build a snowman 等等 </mark>
...
<mark>子墨对于第三人称单数基本掌握，能够基本熟练运用 Does 来提问并做出回答。对于天气词汇除了 <em>windy</em> 之外都掌握不错。对于问题回答、游戏活动参与积极。 </mark>
...
- 学习 Magic *e* 
	...
	- [*ake*](https://elt.oup.com/elt/students/oxfordphonicsworld/video/opw_sb3_u01_ake.mp4?cc=cn&selLanguage=zh)
	- [*ame*](https://elt.oup.com/elt/students/oxfordphonicsworld/video/opw_sb3_u01_ame.mp4?cc=cn&selLanguage=zh)
	- [*ate*](https://elt.oup.com/elt/students/oxfordphonicsworld/video/opw_sb3_u01_ate.mp4?cc=cn&selLanguage=zh)
	- [*ave*](https://elt.oup.com/elt/students/oxfordphonicsworld/video/opw_sb3_u01_ave.mp4?cc=cn&selLanguage=zh)
...
{% grouppicture 2-2 %}
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/Molly-OD1-U5-test1.jpeg)
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/Molly-OD1-U5-test2.jpeg)
{% endgrouppicture %}

- Unit 5 *Where do animals live* 小测试
	- Molly 词汇、语法、阅读和写作总体都掌握得很好
...
- 完成课后练习题
- <mark>本次阅读文本对Molly比较适中，在阅读后能够用关键词或句子说出每个季节的不同特点。比如能说出 In fall, red, orange and yellow leaves. In winter, we can see snow. 但对于文中 “leaves turn red …” “The snow covers the ground” 的表达还不熟悉，可以再熟悉一下文本哟。</mark>
...
{% grouppicture 2-2 %}
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/molly-OD1-U4-test1.jpeg)
![](https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/molly-OD1-U4-test2.jpeg)
{% endgrouppicture %}

- 讲解 U3 测试并完成 U4 小测试（<mark>子墨选对</mark>）
- **故事阅读**
	- 通过图片复习并引导孩子们复述 Anak 不同年龄段做的事
	- 学习故事 *My Friend Anak* 后半部分，解决生词和文本大意
	- 完成课后关于故事的练习题（<mark>子墨对文本表示很有趣，很喜欢这个故事，也能用自己的话来表达理由</mark>）
- **听力**
	- 学习不同时间段的词汇（只有 midday 是生词）
...
<video width="100%" height="auto" controls>
  <source src="https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/english/IMG_0231.mp4" type="video/mp4">
</video>
...
1. 检查练习册作业 <mark>有两个小错误，指出后已更正</mark>
...
<mark>
本次课程的词汇部分对于子墨来说基本上是新的，科学知识的层面也比较特别，讲述的并不是国内常见的动物。子墨状态稳定，文本理解掌握很好。
</mark>
...
<mark>
- 子墨的语调有一定进步，能够越来越自信地朗读
- 对参与课堂活动格外积极热情，抓住每一次操练的机会
- 完成练习速度快，完成后也会主动帮助其他同学
</mark>
...
1. 检查诗歌朗读情况和练习册作业
	<audio controls>
	  <source src="https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/2024/10/25/molly-2024-10-25.m4a" type="audio/mp3">
	</audio>
	
	<mark>Molly 的发音准确，但部分语句语调不够自然，需要继续模仿语调和情绪；练习册没有问题，注意人名首字母大写</mark>
...
6. 学习语法 Nouns, 了解 nouns 可以是 person, place or thing
7. 学习关于海洋和艺术的词汇 P36
...
1. 练习册检查及订正讲解（错两个）
	1. <mark>没有理解 Is A like B 的意思</mark>
	2. <mark>This (is) 忘记 be 动词</mark>
2. 自然拼读 
...
5. 学习诗歌 *Who’s In the Tree* & *Colors of the Sky*
	...
	- 有感情地朗读诗歌，注意录音的情绪（<mark>子墨的情绪投入和语调模仿还需要提高</mark>）
6. 学习并操练语法 There is / There are
	- 看图片，用目标句型说一说看到的动物（<mark>子墨掌握熟练</mark>）
	  <video width="100%" height="auto" controls>
	  <source src="https://mini-elephant-1318622621.cos.ap-chongqing.myqcloud.com/2024/10/20/IMG_0080.mp4" type="video/mp4">
	  </video>
	- 读句子，选择相应的图片
	- 完成相关练习题单（<mark>笔头练习不够仔细，书写注意，忘记写 be 动词</mark>）
