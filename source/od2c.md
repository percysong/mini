...
- 学习P30-31文本 *What is our world made of?*
	- 复习三态的词汇（<mark>词汇部分没有做好复习，有一些不熟悉</mark>）
	- 用思维工具帮助梳理物质三态的特点及三态之间的转变
- 扩展不同物质的词汇，通过阅读线索和听力来猜测物品（<mark>难度对他们相当，都有一两个是不确定的，通过推断基本可以完成全部的判断</mark>）
- 口语交际：如何用英语来请求对方递物品
- 学习可以同时作为名词和动词的词汇
- 了解碘元素升华的物质转换
- 学习 BrainPop 三态转换的视频，扩展学习并完成练习
	- **condense**
		- to change from a gas to a liquid
	- **evaporate**
		- to change from a liquid to a gas
	- **water vapor**
		- water in the form of gas, or tiny drops of water in the air
...
- 复习 P30–31 课文 *What is our world made of?* 听录音，跟读两遍，注意物质转化的语言表达
...
- 在A5纸上（已粘贴至书上）用 diagram 画出物质三态之间的转换
...
- 自助学习 BrainPop 关于物质三态的视频，思考它们都有哪些特点，如何变化
